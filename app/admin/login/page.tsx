...
export default function AdminLogin() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#111111] to-gray-900">
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#111111] to-gray-900 p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-serif font-bold text-[#111111]">Admin Login</h1>
          <p className="text-gray-500 mt-2">Sign in to manage Joviter&apos;s Kitchen</p>
        </div>
        <CustomAuth onSuccess={() => router.push('/admin')} />
      </div>
    </div>
  )
}
