...
//       {/* Mobile top bar */}
//       <div className="md:hidden fixed top-0 left-0 right-0 z-40 bg-[#111111] text-white flex items-center justify-between px-4 py-4 border-b border-[rgba(212,175,55,0.3)]">
//         <Link href="/admin" className="flex items-center gap-3" onClick={() => setIsSidebarOpen(false)}>
//           <div className="w-9 h-9 rounded-full flex items-center justify-center bg-[#D4AF37] text-[#111111] text-sm font-serif">
//             JK
//           </div>
//           <span className="text-sm font-semibold tracking-wider font-serif">Admin Panel</span>
//         </Link>
//         <button
//           type="button"
...
//       <aside
//         className={`w-64 bg-[#111111] text-white flex flex-col fixed inset-y-0 left-0 z-50 transform transition-transform duration-300 md:static md:translate-x-0 md:z-auto ${
