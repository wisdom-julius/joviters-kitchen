...
//             setShowModal(true)
//           }}
//           className="px-8 py-3 bg-[#111111] text-white font-semibold rounded-full hover:bg-[#D4AF37] hover:text-[#111111] transition-all duration-300 flex items-center gap-3 shadow-lg"
//         >
