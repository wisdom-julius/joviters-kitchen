      ...
      <div className="bg-gradient-to-br from-[#111111] to-[#222222] py-16 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center gap-8">
            <div className="w-28 h-28 rounded-full bg-gradient-to-br from-[#D4AF37] to-[#B8941F] flex items-center justify-center shadow-2xl border-4 border-white/10 flex-shrink-0">
